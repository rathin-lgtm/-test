with attributes as (
    ...
    FROM
        {{ ref('dim_portfolios') }} portfolio
    LEFT JOIN {{ ref('dim_type_broad') }} type_broad
    ...
    LEFT JOIN {{ ref('dim_company_industry_hierarchy') }} dim_company
